...
def mask_detection():
    ...
    # with tf.io.gfile.FastGFile('xyz.pb','rb') as f:
	#     graph_def=tf.GraphDef()
	#     graph_def.ParseFromString(f.read())
    # with tf.Session() as sess:
	#     sess.graph.as_default()
	#     tf.import_graph_def(graph_def, name='')
    with tf.io.gfile.GFile('xyz.pb','rb') as f:
...
label=Label(topframe,text="Covid-19 Solution Compliance",font=my_font,foreground="#200142").pack()
...
Bt1=Button(rightframe,text="Detect Eyes" , width=35, bd=1 ,pady=10 , activebackground="green", command=eyes_detection, relief=RAISED)
Bt1.pack(fill=X, pady=10)
Bt2=Button(rightframe,text="Detect Redness" , width=35, bd=1 ,pady=10 , activebackground="green", command=redness_detection, relief=RAISED)
Bt2.pack(fill=X, pady=10)
Bt3=Button(rightframe,text="Detect Face Mask" , width=35, bd=1 ,pady=10 , activebackground="green", command=mask_detection, relief=RAISED)
Bt3.pack(fill=X, pady=10)
# Bt4=Button(rightframe,text="Monitor Social Distancing" , width=35, bd=1 ,pady=10 , activebackground="green", command=social_distancing, relief=RAISED)
# Bt4.pack(fill=X, pady=10)
Bt5=Button(rightframe,text="Stop",width=35, bd=1 ,pady=10, activebackground="green", command=stop, relief=RAISED)
Bt5.pack(fill=X, pady=10)
# Bt3=Button(rightframe,text="Attendance File",width=35, bd=1 ,pady=10 , activebackground="green", relief=RAISED)
# Bt3.pack(fill=X, pady=10)
Bt6=Button(rightframe,text="EXIT",width=35, bd=1 ,pady=10 , activebackground="green", command=exit, relief=RAISED)
Bt6.pack(fill=X, pady=10)	
